...
{
    class BetcityController
    {
        Quobject.SocketIoClientDotNet.Client.Socket parentsocket;
        RichTextBox parentrich;
        public TennisGames BookmakerTennisGames;

        public BetcityController(Quobject.SocketIoClientDotNet.Client.Socket Sock, RichTextBox rich)
        {
            BookmakerTennisGames = new TennisGames();
            this.BookmakerTennisGames.CurrentBooker = TennisGames.Bookers.BetCity;
            parentsocket = Sock;
            parentrich = rich;
            parentsocket.On("betcityMessage", (data) =>
            {
