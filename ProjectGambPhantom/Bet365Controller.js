...
function Parse() {
    ...
    Bet365.ParentBrowser[0].page.evaluate(function () {
        function OPenAllFrames() {
            ...
            var link = "https://mobile.365sb.com/mobilepreload/?pt=13&tl=15299657325C13_1_3;"
            for (var i = 0; i < arr.length; i++) {
                link += arr[i] + ';';
            }
            link +="CONFIG_1_3;LIInPlay_1_3;__time&ci=158";
            ...
            if (listl != undefined)
                for (var i = 0; i < listl.length; i++) {
                    ...
                    if (Player1 != "") {
                        ...
                        var MatchBets = listl[i].children[0].contentDocument.getElementsByClassName('Market');
