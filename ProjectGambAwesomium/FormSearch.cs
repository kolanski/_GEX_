...
namespace ProjectGambAwesomium
{
    public partial class FormSearch : Form
    {
        ...
        public FormSearch()
        {
           ...
           // this.Location = new Point(Program.myForm1.Height, 0);
            search = new SearchArbitrage();
        }

        private async void SearchParseAll_Click(object sender, EventArgs e)
        {
                await Program.myForm1.SendToSearchForm();
        }
        ...
        private void AutoButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Debug.WriteLine("ErrinFormsearch:" + k);
            }
        }
             ...
             Action<object> action = (object obj) =>
        {
         ...
         //   fulltext += search.Log;
            ...
            search.CompareTennisGames(Program.myForm1.GetBetCityGames(), Program.myForm1.GetPariMatchGames());
            fulltext += search.Log;

            search.CompareTennisGames(Program.myForm1.GetBetCityGames(), Program.myForm1.GetFonbetGames());
            fulltext += search.Log;

         //  search.CompareTennisGames(Program.myForm1.GetBetCityGames(), Program.myForm1.GetUniBet());
         //  fulltext += search.Log;

            search.CompareTennisGames(Program.myForm1.GetBetCityGames(), Program.myForm1.GetBet365());
            fulltext += search.Log;

            search.CompareTennisGames(Program.myForm1.GetBetCityGames(), Program.myForm1.GetWilliamsGames());
            fulltext += search.Log;

            search.CompareTennisGames(Program.myForm1.GetBetCityGames(), Program.myForm1.GetMarathon());
            fulltext += search.Log;

            //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetPariMatchGames());
           // fulltext += search.Log;
           //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetFonbetGames());
           // fulltext += search.Log;
           //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetUniBet());
           // fulltext += search.Log;
           //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetBet365());
           // fulltext += search.Log;
           //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetWilliamsGames());
           // fulltext += search.Log;
           //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetMarathon());
           // fulltext += search.Log;
           //
           // search.CompareTennisGames(Program.myForm1.GetBetInternetGames(), Program.myForm1.GetBetCityGames());
           // fulltext += search.Log;
        ...
        {
            this.panel1.Size = new Size(this.Width-30, 450);
        }
